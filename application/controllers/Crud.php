...
class Crud extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->layout->setLeft('layout/left_crud');
        $this->layout->setLayout('crud_layout');
    ...
    {
        $data[] = '';
        $this->layout->view('Crud/index', $data);
    }
    ...
    {
        $txt = read_file('./crud/Controller.txt');
        ...
        foreach ($data['formcreate'] as $c) {
            ...
            $text = explode(",", $c);
           // $arr_search = array_search($text[0],$txt_select );

                    $txt_select_html .= '$sub_array[] = $row->' . $text[0] . ';';


            if ($text[3] != '') {
                $txt_sl .= '$data["' . $text[3] . '"] = $this->crud->get_' . $text[3] . '();';
            }
        }
